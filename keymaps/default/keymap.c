...
[BASE] = KEYMAP(
  KC_F1, KC_F2,   KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL,  KC_BSPC,  KC_INS, KC_PGUP,
  ...
  KC_F9, KC_F10,  KC_LCTL, KC_LALT, KC_LGUI,              KC_SPC,           KC_LGUI, KC_LALT, KC_MENU,  KC_LEFT, KC_DOWN, KC_RGHT),
   ...
   * |---------|  |-------------------------------------------------------------|  `---------'
   * | F5 | F6 |  |MO(FUNC)|Lft|Dn |Rig|PgD|  G|  H|  J|  K|  L|  ;|  '|Return  |
   * |---------|  |-------------------------------------------------------------|  ,----.
